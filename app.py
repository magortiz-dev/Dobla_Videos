...
# Fallback opcional (no siempre funciona): si no defines traductor, prueba con Speech
# (Solo si tu organización ha configurado un recurso que comparta credenciales)
